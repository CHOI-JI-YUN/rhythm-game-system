...
또한 팀 프로젝트로 진행되었으며, 담당한 Music TokTok 스테이지를 다른 팀원의 게임과 연결하여 하나의 게임 흐름으로 구성했습니다.
...
## 👨‍💻 구현 내용
- SFML 기반 메인 화면 및 난이도 선택 UI 구현
- 방향키 입력 기반 리듬 판정 시스템 구현
- PERFECT / GOOD / MISS 판정 로직 구현
- 점수, 콤보 및 라이프 시스템 구현
- 난이도별 노트 속도 및 생성 개수 처리 구현
- 게임 오버 및 결과 화면 구현

---

## 🙋 담당 역할
- Music TokTok 리듬 게임 스테이지 개발
- 메인 화면 및 난이도 선택 UI 구현
- 방향키 입력 기반 리듬 판정 시스템 구현
- PERFECT / GOOD / MISS 판정 로직 구현
- 점수, 콤보 및 라이프 시스템 구현
- 게임 오버 및 결과 화면 구현
...
## 🚀 프로젝트 특징
- Music TokTok 리듬 게임 스테이지 구현
- PERFECT / GOOD / MISS 기반 판정 시스템 구현
- Easy / Normal / Hard 난이도 시스템 구현
- 점수, 콤보 및 라이프 기반 게임 시스템 구현
- 게임 오버 및 결과 화면 구현
- 5단계 스테이지형 게임 구조 적용
